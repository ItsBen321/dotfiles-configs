...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(codex))
...
-- More custom binds
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("hyprshot -clipboard-only -m window"))
...
hl.bind(mainMod .. " + SHIFT + agrave", hl.dsp.window.move({ workspace = 0 }))
--end
